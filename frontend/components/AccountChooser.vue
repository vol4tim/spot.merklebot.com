    ...
    <div class="relative p-1 flex items-center w-full space-x-4 justify-end">
      <div class="w-128">
        <div v-if="wallet.selectedAccount.account" class="mt-1 relative">
          <button
            type="button"
            class="relative w-full bg-gray-600 text-white rounded-md shadow-lg pl-3 pr-10 py-3 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-white sm:text-sm"
          ...
          <div v-show="showAccountChoose" class="absolute mt-1 w-full z-10 rounded-md bg-gray-600 shadow-lg">
            <ul
              tabindex="-1"
              role="listbox"
            ...
            >
              <li
                ...
                :value="account"
                role="option"
                class="text-white  cursor-default hover:bg-indigo-500 hover:text-white select-none relative py-2 pl-3 pr-9"
