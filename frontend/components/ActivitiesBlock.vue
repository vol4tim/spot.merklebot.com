<template>
  <div class="flex">
    ...
    >
      ...
      >
        <div
          class="bg-gray-700 border-2 border-white mx-6 my-12 px-6 py-8 align-middle"
        >
          <a id="anchor-to-1" href="#1">
            <h3
              id="anchor-to-1"
              class="max-w-md text-xl md:text-2xl font-bold mx-6 text-white"
            >
      ...
      >
        <div
          class="bg-gray-700 border-2 border-white mx-6 my-12 px-6 py-8"
        >
      ...
      >
        ...
        >
          <a id="anchor-to-4" href="#4">
            <h3
              id="4"
              class="w-full text-xl md:text-2xl font-bold mx-6 text-white"
            >
